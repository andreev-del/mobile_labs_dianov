...
class CommandRunner {
  ...
  /// Если указан, вывод идёт сюда, иначе в print()
  FutureOr<void> Function(String)? onOutput;

  /// Если указан, ошибки идут сюда, иначе rethrow
  ...
  ArgResults parse(List<String> input) {
    ...
    // Проверка: первый аргумент должен быть известной командой
    ...
    // Проверка: не может быть двух команд
    if (results.command != null &&
        input.isNotEmpty &&
    ...
    // Обработка опций (--verbose, --command=search и т.д.)
    ...
    while (i < input.length) {
      if (input[i].startsWith('-')) {
        ...
        // Поиск опции среди зарегистрированных для этой команды
