...
abstract class Command extends Argument {
  ...
  late CommandRunner runner; // Это ссылка на главный класс, который будет выполнять команды
  ...
  // Ключевой метод, который будет содержать логику команды
...
class ArgResults {
  ...
  bool hasOption(String name) => options.keys.any((option) => option.name == name || option.abbr == name);
